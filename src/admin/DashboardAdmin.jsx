            ...
            <div className="dashboard-nav-dropdown-menu">
              <a
                ...
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "addfaculty" && "active text-warning fs-5"
                }`}
              ...
              <a
                href="#"
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "viewfaculty" && "active text-warning fs-5"
                }`}
          ...
          <div className="dashboard-nav-dropdown">
            ...
            <div className="dashboard-nav-dropdown-menu">
              <a
                href="#"
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "addstudent" && "active text-warning fs-5"
                }`}
              ...
              <a
                href="#"
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "viewstudent" && "active text-warning fs-5"
                }`}
          ...
          <div className="dashboard-nav-dropdown">
            ...
            <div className="dashboard-nav-dropdown-menu">
              <a
                href="#"
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "addsubject" && "active text-warning fs-5"
                }`}
              ...
              <a
                href="#"
                className={`dashboard-nav-dropdown-item ${
                  clickRender === "viewsubject" && "active text-warning fs-5"
                }`}
          ...
          <div className="container">
            <div className="card">
              ...
              <div className="card-body">
                {clickRender === "addfaculty" && <AddFaculty />}
                {clickRender === "viewfaculty" && <ViewFaculties />}
                {clickRender === "addstudent" && <AddStudent />}
                {clickRender === "viewstudent" && <ViewAllStudents />}
                {clickRender === "addsubject" && <AddSubject />}
