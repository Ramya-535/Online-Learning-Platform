      ...
      <div className="dashboard-nav">
        ...
        <nav className="dashboard-nav-list">
          ...
          <a
            ...
            className={`dashboard-nav-item text-wrap active ${
              clickRender === "study" && " text-warning "
            }`}
            onClick={() => handleClicks("study")}
          >
            <i className="fa-solid fa-chalkboard-user"></i>Study Material
          </a>
          {/* <a href="#" className="dashboard-nav-item" onClick={() => handleClicks("assignment")}>
            Upload Assignment
          </a> */}
          <div className="dashboard-nav-dropdown">
            ...
            <div className="dashboard-nav-dropdown-menu">
              {/* <a
                ...
                onClick={() => handleClicks("addstudent")}
              >
                Add 
              </a> */}
              <a
                href="#"
                // className="dashboard-nav-dropdown-item"
                className={`dashboard-nav-dropdown-item text-wrap active ${
                  clickRender === "send" && " text-warning fs-5  "
                }`}
                onClick={() => handleClicks("send")}
              >
                Upload
              </a>
              <a
                ...
                // className="dashboard-nav-dropdown-item"
                className={`dashboard-nav-dropdown-item text-wrap active ${
                  clickRender === "assignment" && " text-warning fs-5  "
                }`}
          ...
          <a
            ...
            // className=""
            className={`dashboard-nav-item text-wrap active ${
              clickRender === "placement" && " text-warning   "
            }`}
            onClick={() => handleClicks("placement")}
          >
            <i className="fa-solid fa-list-check"></i> Interview Questions
          </a>
          <a
            href="#"
            // className="dashboard-nav-item active text-wrap "
          ...
          <Link to="/" className="dashboard-nav-item" onClick={()=>sessionStorage.removeItem("student")}>
      ...
      <div className="dashboard-app">
        ...
        <div className="dashboard-content ">
          <div className="container">
            {clickRender === "study" && <ViewStudyMaterial />}
            {/* <div className="card">
            ...
            {clickRender === "send" && <SendAssignMent />}
            {clickRender === "profile" && <StudentProfile />}
            {clickRender === "placement" && <ViewInterviewQuestions />}
            {clickRender === "assignment" && <Assignments />}
            {clickRender === "marks" && <Marksheet />}
            {clickRender === "home" && (
              <div>
                {/* <div>
                      <marquee direction="up"   className="marquee-text d-flex justify-content-center  align-content-center align-items-lg-stretch ">
                        <p className="text-decoration-underline text-info">
                         Aditya registered on 17th-feb-2024;  <span className="text-decoration-underline text-danger">
                         &nbsp; &nbsp; Vinay Submitted the aassignment; &nbsp;&nbsp;
                        </span>
                       
                        <span className="text-decoration-underline text-primary ">
                          New Subject DSA added;
                        </span>
                        </p>
