      ...
      <div className="dashboard-nav">
        ...
        <nav className="dashboard-nav-list">
          <a
            ...
            className={`dashboard-nav-item text-wrap active ${clickRender === "home"&&' text-warning  '}`}
          ...
          <a
            ...
            className={`dashboard-nav-item text-wrap active ${clickRender === "post"&&' text-warning   '}`}

            onClick={() => handleClicks("post")}
          >
            <i className="fa-solid fa-chalkboard-user"></i>Post Questions
          </a>
          ...
          <a
            href="#"
            // className="dashboard-nav-item "
            className={`dashboard-nav-item text-wrap active ${clickRender === "view"&&' text-warning  '}`}

            onClick={() => handleClicks("view")}
          >
            <i className="fa-solid fa-file-circle-question"></i>
            View Questions
          </a>

          {/* <a href="#" className="dashboard-nav-item" onClick={()=>handleClicks("profile")}>
            <i className="fas fa-user"></i> Profile
          </a> */}
          <div className="nav-item-divider"></div>
          <Link to="/" className="dashboard-nav-item" onClick={()=>sessionStorage.removeItem("placement")}>
      ...
      <div className="dashboard-app">
        ...
        <div className="dashboard-content ">
          <div className="container">
            <div className="">
              <div className="">
                {/* {clickRender==="profile"&&<PlacementProfile/>} */}
                {clickRender === "post" && <PostQuestions />}
                {clickRender === "view" && <ViewQuestions />}
              </div>
              <div className="">
                {clickRender === "home" && (
